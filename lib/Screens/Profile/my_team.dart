    ...
    return Scaffold(
      ...
      Padding(
          ...
          child: SafeArea(
            ...
            TeamStory(teamTitle: "Living Room", numberOfMembers: "12", noImages: "8"),
            Container(
            ...
            AppSpaces.verticalSpace40,
            TeamStory(teamTitle: "Kitchen", numberOfMembers: "12", noImages: "8"),
            Container(
              height: Utils.screenHeight / 2,
              child: GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            AppSpaces.verticalSpace40,
            TeamStory(teamTitle: "Bathroom", numberOfMembers: "12", noImages: "8"),
            Container(
              height: Utils.screenHeight / 2,
              child: GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
